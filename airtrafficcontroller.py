...
class ATC:
    ...
    def has_reached_end_vertiport(self, uav:UAV):
        ...
        Returns:
            None
        '''
        if (uav.current_position.distance(uav.end_point) <= uav.landing_proximity) and (uav.reached_end_vertiport == False):
    ...
    def has_left_start_vertiport(self, uav: UAV):
        ...
        Returns:
            None
        '''
        if (uav.current_position.distance(uav.start_point) > 100) and (uav.left_start_vertiport == False):
            self._clearing_procedure(uav)
            uav.left_start_vertiport = True
